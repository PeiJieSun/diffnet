...
The dataset flickr we use from this paper:
 ...
 We utilized the key technique in following paper to tackle the graph oversmoothing issue, and we hav highlighted the change 
 in line 114 in diffnet/diffnet.py, if you wang to konw more details, please refer to:
 @inproceedings{
